...
class AdministratorDashboard extends React.Component {
    ...
    // ova metoda sluzi cisto da pokusamo "nesto" da pribavimo pod rolom administratora i ako uspemo onda smo ulogovani 
    // a ako ne uspemo onda ssetuje login state na false i redirektuje 
    private getMyData() {
